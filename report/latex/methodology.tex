...
\begin{tikzpicture}[
    ...
    \draw[arrow, dashed] (refine.west) -- ++(-0.4,0) |- (gen.south);
\end{tikzpicture}%
}
...
The master workflow coordinates the agents: (1) Planner creates the implementation plan; (2) Coder generates code; (3) code is executed and metrics computed; (4) Critic reviews and provides feedback; (5) if issues found, Coder refines with feedback. The loop continues until correct or maximum iterations reached.
